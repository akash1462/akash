...
//		return "Vendor [id=" + id + ", name=" + name + ", reg_no=" + reg_no + ", vendor_type=" + vendor_type
//				+ ", address=" + address + ", country=" + country + ", state=" + state + ", vendor_email="
//				+ vendor_email + ", contact_number=" + contact_number + ", website=" + website + ", cert_issue_date="
//				+ cert_issue_date + ", cert_validity_date=" + cert_validity_date + ", year_establishment="
//				+ year_establishment + ", payment_gateway=" + payment_gateway + ", roles=" + roles + "]";
//	}
